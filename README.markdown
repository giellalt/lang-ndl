...
This directory contains source files for the Ndolo language morphology
...
-   <https://giellalt.uit.no/lang/ndi/index.xml> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
------------

In order to compile and use Ndolo language morphology and dictionaries,
you need:
...
The Ndolo language sources can be acquired using [giella SVN
